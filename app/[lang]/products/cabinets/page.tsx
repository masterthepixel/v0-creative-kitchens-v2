...
export default function CabinetsPage() {
  ...
  const content = {
    en: {
      heroTitle: "Cabinets for Every Space",
      heroDesc:
      ...
      indoorBtn: "Explore Indoor Cabinets",
      outdoorBtn: "Explore Outdoor Cabinets",
    },
    es: {
      heroTitle: "Gabinetes para Cada Espacio",
      heroDesc:
        "Descubre marcas premium de gabinetes para interiores y exteriores para cocinas, baños y espacios al aire libre. Estilo, durabilidad y funcionalidad—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Gabinetes Interiores",
      outdoorBtn: "Explorar Gabinetes Exteriores",
    },
  }

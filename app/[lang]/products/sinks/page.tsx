...
export default function SinksPage() {
  ...
  const content = {
    en: {
      heroTitle: "Kitchen and Bathroom Sinks",
      heroDesc:
        "Choose from our versatile sink collection, featuring designs that balance practical workspace needs with sophisticated style. Quality, functionality, and aesthetics—trusted by homeowners and professionals.",
      indoorBtn: "Explore Kitchen Sinks",
      outdoorBtn: "Explore Bathroom Sinks",
    },
    es: {
      heroTitle: "Fregaderos de Cocina y Baño",
      heroDesc:
        "Elige de nuestra versátil colección de fregaderos, con diseños que equilibran las necesidades prácticas del espacio de trabajo con un estilo sofisticado. Calidad, funcionalidad y estética—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Fregaderos de Cocina",
      outdoorBtn: "Explorar Fregaderos de Baño",
    },
  }

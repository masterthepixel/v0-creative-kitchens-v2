...
export default function HardwarePage() {
  ...
  const content = {
    en: {
      heroTitle: "Quality Cabinet Hardware",
      heroDesc:
        "Perfect your design with our curated hardware collection, where small details make a significant impact in your space. Style, durability, and functionality—trusted by homeowners and professionals.",
      indoorBtn: "Explore Cabinet Hardware",
      outdoorBtn: "Explore Accessories",
    },
    es: {
      heroTitle: "Herrajes de Calidad",
      heroDesc:
        "Perfecciona tu diseño con nuestra colección de herrajes, donde los pequeños detalles generan un impacto significativo en tu espacio. Estilo, durabilidad y funcionalidad—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Herrajes para Gabinetes",

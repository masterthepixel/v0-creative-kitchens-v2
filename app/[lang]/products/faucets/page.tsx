...
export default function FaucetsPage() {
  ...
  const content = {
    en: {
      heroTitle: "Premium Faucets",
      heroDesc:
        "Elevate your daily routine with our premium faucets, merging elegant design with advanced functionality for lasting performance. Style, durability, and innovation—trusted by homeowners and professionals.",
      indoorBtn: "Explore Kitchen Faucets",
      outdoorBtn: "Explore Bath Faucets",
    },
    es: {
      heroTitle: "Grifos Premium",
      heroDesc:
        "Eleva tu rutina diaria con nuestros grifos premium, fusionando diseño elegante con funcionalidad avanzada para un rendimiento duradero. Estilo, durabilidad e innovación—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Grifos de Cocina",
      outdoorBtn: "Explorar Grifos de Baño",
    },
  }

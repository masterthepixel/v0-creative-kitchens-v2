...
export default function CountertopsPage() {
  ...
  const content = {
    en: {
      ...
      indoorBtn: "Explore Indoor Countertops",
      outdoorBtn: "Explore Outdoor Countertops",
    },
    es: {
      ...
      indoorBtn: "Explorar Encimeras Interiores",
      outdoorBtn: "Explorar Encimeras Exteriores",
    },
  }

"use client"
import AppliancesLogoCloud from "@/components/appliances-logo-cloud"
...
export default function AppliancesPage() {
  ...
  const content = {
    en: {
      ...
      exploreBtn: "Explore Our Appliances",
    },
    es: {
      heroTitle: "Electrodomésticos Premium",
      heroDesc:
      ...
      exploreBtn: "Explorar Nuestros Electrodomésticos",
    },
  }
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="#appliances" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-slate-900 hover:bg-slate-800 focus:ring-4 focus:ring-slate-300 dark:focus:ring-slate-900">
                {t.exploreBtn}

...
export default function DoorHardwarePage() {
  ...
  const content = {
    en: {
      heroTitle: "Door Hardware Solutions",
      heroDesc:
        "Make a statement with distinctive door hardware options that add character and security to your entrances and passages. Style, quality, and functionality—trusted by homeowners and professionals.",
      indoorBtn: "Explore Door Handles",
      outdoorBtn: "Explore Door Knobs",
    },
    es: {
      heroTitle: "Soluciones de Herrajes para Puertas",
      heroDesc:
        "Haz una declaración con opciones distintivas de herrajes para puertas que añaden carácter y seguridad a tus entradas y pasajes. Estilo, calidad y funcionalidad—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Manijas para Puertas",
      outdoorBtn: "Explorar Pomos para Puertas",
    },
  }
      ...
      <section>
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <Image
              src="/door-hardware.jpg"
              alt="Door Hardware Showcase"
              width={500}
              height={500}

...
export default function MedicineCabinetsPage() {
  ...
  const content = {
    en: {
      heroTitle: "Medicine Cabinets",
      heroDesc:
        "Combine storage and style with our medicine cabinets, offering practical solutions without compromising on design aesthetics. Style, functionality, and organization—trusted by homeowners and professionals.",
      indoorBtn: "Explore Medicine Cabinets",
      outdoorBtn: "Explore Accessories",
    },
    es: {
      heroTitle: "Botiquines",
      heroDesc:
        "Combina almacenamiento y estilo con nuestros botiquines, ofreciendo soluciones prácticas sin comprometer la estética del diseño. Estilo, funcionalidad y organización—con la confianza de propietarios y profesionales.",
      indoorBtn: "Explorar Botiquines",
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <Image
              ...
              alt="Medicine Cabinets Showcase"
              width={500}
              height={500}

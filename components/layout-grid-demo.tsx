...
const SkeletonFive = () => {
  return (
    <div>
      <p className="font-bold md:text-4xl text-xl text-white">Forest retreat</p>
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        A luxurious retreat nestled in the forest, offering privacy and a connection with nature that rejuvenates the
        soul.
      </p>
    </div>
  )
...
const SkeletonSix = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        Enjoy panoramic views of misty mountains from this elevated home, where every morning brings a new perspective
        on natural beauty.
      </p>
    </div>
  )
...
const SkeletonSeven = () => {
  return (
    <div>
      <p className="font-bold md:text-4xl text-xl text-white">Cottage garden</p>
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        A charming cottage surrounded by vibrant gardens, creating a picturesque setting that feels like it's from a
        storybook.
      </p>
    </div>
  )
...
const SkeletonEight = () => {
  return (
    <div>
      <p className="font-bold md:text-4xl text-xl text-white">Riverside escape</p>
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        This riverside property offers the soothing sounds of flowing water and spectacular views, perfect for those who
        find peace near water.
      </p>
    </div>
  )
}
...
const cards = [
  {
    id: 1,
    content: <SkeletonOne />,
    className: "md:col-span-2 h-[400px] md:h-[500px]",
    thumbnail:

...
export default function ExternalCabinetryLogoCloud() {
  const logos = [
    { name: "Naturekast", href: "https://www.naturekast.com/stylesandfinishes" },
    { name: "XO Outdoor", href: "https://xoappliance.com/outdoor-kitchens-products/grill-storage/" },
    { name: "Outdoor Refinements", href: "https://www.homerefinements.ca/en_us/outdoor-living" },
  ]
  return (
        ...
        <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
          <div className="mx-auto w-full max-w-xl lg:mx-0">
            ...
            <p className="mt-6 text-lg/8 text-slate-700 dark:text-slate-300">
              Explore our curated selection of premium outdoor cabinetry brands, perfect for your exterior living spaces.
            </p>
            <div className="mt-8 flex justify-center lg:justify-start">
              <Image
                src="/outdoor-cabinetry.jpg"
                alt="Outdoor Cabinetry Hero"
                width={600}
                height={300}
